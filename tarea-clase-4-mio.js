...
const tarea1 = $form.querySelector("#boton-tarea1");
const tarea2 = $form.querySelector("#boton-tarea2");
const tarea3 = $form.querySelector("#boton-tarea3");
const tarea4 = $form.querySelector("#boton-tarea4");
const desafios = $form.querySelector("#boton-desafios");
const nodoResultadoTareas = document.querySelector("#resultados");
const nodoResultadoDesafios = document.querySelector("#desafios");
